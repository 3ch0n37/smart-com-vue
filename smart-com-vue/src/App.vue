...
<template>
  <main>
    <div class="container">
      ...
      <p>Lists with drag-drop functionality. Made using Vue, Typescript, Bootstrap and Sortable.JS</p>
      <div class=row>
        <div class="col-6">
          <SortableComponent :list-items="list1" />
        </div>
        <div class="col-6">
          <SortableComponent :list-items="list2" />
        </div>
      </div>
    </div>
  </main>
